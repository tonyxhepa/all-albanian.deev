    ...
    <div class="row">
        <div class="col-sm-24">
            <div class="panel panel-primary">
                <div class="panel-heading">Posto elektroniket e tua</div>
                <div class="panel-body" style="background-color: #7da8c3">
    <form method="POST" action="{{ url(Auth::user()->slug.'/profile/elektroniketemia') }}" enctype="multipart/form-data" class="form-horizontal">
        {{ csrf_field() }}
        ...
        <div class="form-group">
            <label for="elektronik_cats_id" class="col-sm-4 control-label">Kategoria</label>
            <div class="col-sm-18 col-sm-offset-2">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-18 col-sm-offset-2">
                    <select name="country_id" id="country_id" class="form-control" v-model="country_id" v-on:change="getCountryModel()" v-bind:disabled="disableWhenSelect">
                        <option value="">--- Zhjidh Shtetin ---</option>
