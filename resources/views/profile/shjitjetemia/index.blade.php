...
@section('content')
    ...
    @endif
               ...
               <div class="row">
                   <div class="panel-primary">
                       <div class="panel-heading">
                           Shitjet e mia
                           <span class="badge">{{ count($shitjet) }}</span>
                       </div>
                           ...
                           <table class="table table-hover">
                               ...
                               @foreach($shitjet as $post)
                                   <tr>
                                       ...
                                       <td><a href="{{ url(Auth::user()->slug. '/profile/shitjetemia/'. $post->id .'/edit') }}"><button class="btn btn-circle btn-primary">edit</button></a> </td>
                                       <td>{!! Form::open(['method'=>'DELETE', 'action'=>['Profile\ProfileShitjeController@destroy', Auth::user()->slug, $post->id]]) !!}
           ...
           @else
    <h3>Ju nuk keni postuar akoma</h3>
    @endif
