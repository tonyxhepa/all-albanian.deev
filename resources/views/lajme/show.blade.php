    ...
    <div class="container">
        <div class="row">
            <div class="col-xs-24 col-sm-12 col-md-18">
                <div class="row">
                    <div class="pull-right">Publikuar: {{ $shiko_lajmet->created_at->format('d M Y - H:i:s') }}</div>
                </div>
                <div class="row">
                    @if(count($shiko_lajmet->photos) >=1)
                            ...
                            <div id="aniimated-thumbnials">
                                @foreach($shiko_lajmet->photos as $photo)
                                    <a class="col-sm-6" href="{{ asset('storage').$photo->thumbnail }}" data-lightbox="roadtrip" data-title="{{ $shiko_lajmet->title }}">
                ...
                <div class="">
                    <h3> {{ $shiko_lajmet->title }}</h3>
                    <div class="">{{ $shiko_lajmet->pershkrimi }}</div>
                </div>
            </div>
