<div class="row" xmlns="http://www.w3.org/1999/html">
        <form method="get" action="{{ url('/tech/kerko') }}">
            <div class="row">
                <div class="col-xs-12 col-sm-6">
                    ...
                    <div class="form-group">
                        ...
                        <select name="tech_cats_id" id="tech_cats_id" class="form-control" v-model="country_id" v-on:change="getCountryModel()" v-bind:disabled="disableWhenSelect">
