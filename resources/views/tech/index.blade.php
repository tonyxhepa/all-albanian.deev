        ...
        <div class="container">
            ...
            <div class="row header-row">
                <div class="col-lg-12 col-md-12 col-sm-24 col-xs-24">
                    ...
                    <div class="row header-row">
                        @foreach($m_sociale_kater as $tre)
                ...
                <div class="col-md-12 col-sm-24 col-xs-24">
                    <div class="row header-row">
                        @foreach($mobile_kater as $katerta)
        ...
        <div class="row">
            <div class="news-row-menu">
                <ul class="list-inline">
                    <li>
                        <a style="color: #eb9316" href="{{ url('/tech/app/') }}">Apps</a>
                    </li>

                    <li class="pull-right hidden-xs">
                        <a href="{{ url('/tech/app/') }}">Te gjitha</a>
                    </li>
                </ul>
            </div>
        </div>
        <div class="row">
            @foreach($apps as $moda)
